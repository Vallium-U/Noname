...
// public class RopeComponents : MonoBehaviour
// {
...
//         points = new RopeParticle[segments + 1];
...
//             points[pointIdx] = new RopeParticle(initialPosition);
//         }

//         // Bind start and end particles with their respective gameobjects
//         RopeParticle start = points[0];
//         RopeParticle end = points[segments];
...
//         foreach (RopeParticle particle in points)
//         {
...
//         {
//             RopeParticle particleA = points[SegIdx];
//             RopeParticle particleB = points[SegIdx + 1];
...
// 	 */
//     void SolveDistanceConstraint(RopeParticle particleA, RopeParticle particleB, float segmentLength)
//     {
...
// 	 **/
//     void SolveStiffnessConstraint(RopeParticle cableParticle, float distance)
//     {
